...
import { useIsBoolean } from "../../hooks/useIsBoolean.ts";
import { PlayerNames, usePlayerName } from "../../hooks/usePlayerName.ts";
import { useScore } from "../../hooks/useScore.ts";
import { useCount } from "../../hooks/useCount.ts";
import { InputPlayerName } from "../InputPlayerName";
import { playerList } from "../../const/playerList.ts";
import { ScoreSelectPanel } from "../ScoreSelectPanel";
import { ScoreSummary } from "../ScoreSummary";
import { COLOR } from "../../const/color.ts";

...
describe("calculatePenalty", () => {
  ...
  it("returns unchanged score when tempaiCount is 0 or 4", () => {
    const emptyFlags: ReachFlagsProps = {
      0: false,
      1: false,
      2: false,
      3: false,
    };
    const allFlags: ReachFlagsProps = { 0: true, 1: true, 2: true, 3: true };
  ...
  it("applies correct adjustments when tempaiCount is 1", () => {
    ...
    const flags: ReachFlagsProps = { 0: false, 1: true, 2: false, 3: false };
  ...
  it("applies correct adjustments when tempaiCount is 2", () => {
    ...
    const flags: ReachFlagsProps = { 0: true, 1: false, 2: false, 3: true };
  ...
  it("applies correct adjustments when tempaiCount is 3", () => {
    ...
    const flags: ReachFlagsProps = { 0: false, 1: true, 2: true, 3: true };
